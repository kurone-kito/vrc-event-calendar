...
This repository consumes the portable IDD template from
`kurone-kito/idd-skill`; it is not the template source of truth.
Update local IDD files in place, and use a fresh upstream import when
you need to adopt newer template revisions.
