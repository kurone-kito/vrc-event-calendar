...
This repository resolves IDD roadmap markers with the configured marker
prefix `vrc-event-calendar`:

- roadmap identity marker: `<!-- vrc-event-calendar-roadmap-id: ... -->`
- sequential dependency marker:
  `<!-- vrc-event-calendar-blocked-by: ... -->`
